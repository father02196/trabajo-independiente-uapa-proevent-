...
import { FiCheckCircle, FiClock, FiFileText, FiCalendar, FiArrowUpRight, FiGrid, FiActivity, FiEye, FiList } from "react-icons/fi";
...
function DashboardEspecialista({ usuario, onEditEvent, setActiveTab }) {
  ...
  const isAudioVisualAdmin = usuario?.rol === "Administrador de Audiovisual";
